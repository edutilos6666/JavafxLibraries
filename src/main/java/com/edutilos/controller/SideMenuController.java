...
@ViewController(value = "/com/edutilos/SideMenu.fxml")
public class SideMenuController {
    ...
    @FXML
    @ActionTrigger("moduleSearch")
    private Label moduleSearch;
    ...
    public void init() {
        ...
        bindNodeToController(moduleSearch, ModuleSearchController.class, contentFlow, contentFlowHandler);
